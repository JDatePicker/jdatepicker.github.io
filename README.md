...
This repository contains the GitHub Pages website for [JDatePicker](https://github.com/JDatePicker/JDatePicker).
...
BSD License - See the main [JDatePicker repository](https://github.com/JDatePicker/JDatePicker) for details
